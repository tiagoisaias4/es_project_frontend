...
import { API_URL_STAFF_LOGIN } from "../constants";


const LoginStaff = ({ staffId, setStaffId, onClose, onStaffSignInSuccess }) => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(API_URL_STAFF_LOGIN, loginData);
      ...
      if (response.status === 200) {
        ...
        // console.log('localstorage:', localStorage.getItem("driverID"))
